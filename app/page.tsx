...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center p-4 md:p-16">
      <div className="w-full max-w-[1440px] flex flex-col md:flex-row items-center justify-center gap-0">
        {/* Left Panel - Logo */}
        <div className="w-full md:w-[624px] h-[400px] md:h-[772px] bg-meraki-cream bg-opacity-50 flex items-center justify-center relative">
        ...
        <div className="w-full md:w-[624px] h-auto md:h-[772px] bg-meraki-cream bg-opacity-[0.09] flex items-center justify-center p-8 md:p-16">
          <div className="w-full max-w-[406px]">
            <form onSubmit={handleContinue} className="space-y-8">
              {/* Title */}
              <h1
                className="text-meraki-principal font-light text-[20px] leading-normal"
              ...
              <div className="relative pt-5">
                <label htmlFor="email" className="text-meraki-principal text-base font-normal block mb-2">
                  Your Email
                </label>
                <input
                  id="email"
                  ...
                  className="w-full bg-transparent border-0 border-b border-meraki-principal border-opacity-50 focus:border-opacity-100 outline-none pb-2 text-meraki-principal transition-all duration-200"
              ...
              {/* Password Input */}
              <div className="relative pt-5">
                <label htmlFor="password" className="text-meraki-principal text-base font-normal block mb-2">
                  Password
                </label>
                <input
                  id="password"
              ...
              <div className="flex justify-center pt-8">
                <button
                  type="submit"
                  className="w-[216px] h-[64px] rounded-[32px] bg-meraki-fondo text-meraki-button font-light text-xl transition-all duration-200 hover:shadow-lg active:scale-95"
                  style={{
                    fontFamily: "'PP Neue Montreal', sans-serif",
                    boxShadow:
                      "-5px -5px 10px 0 rgba(255, 255, 255, 0.60), 5px 5px 10px 0 rgba(217, 217, 217, 0.15), 10px 10px 20px 0 rgba(139, 138, 138, 0.20), -10px -10px 20px 0 #FFF",
                  }}
                >
                  Continue
                </button>
              ...
              <div className="text-center pt-8">
                <p
                  className="text-meraki-body text-base font-normal"
                  style={{ fontFamily: "Arial, sans-serif" }}
                >
              ...
              <div className="flex justify-center pt-4">
                <button
                  ...
                  className="w-[216px] h-[64px] rounded-[32px] bg-meraki-fondo text-meraki-button font-light text-xl transition-all duration-200 hover:shadow-lg active:scale-95 flex items-center justify-center gap-3"
                  style={{
                    fontFamily: "'PP Neue Montreal', sans-serif",
                    boxShadow:
                      "-5px -5px 10px 0 rgba(255, 255, 255, 0.60), 5px 5px 10px 0 rgba(217, 217, 217, 0.15), 10px 10px 20px 0 rgba(139, 138, 138, 0.20), -10px -10px 20px 0 #FFF",
