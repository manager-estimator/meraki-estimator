  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center p-4 md:p-16">
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-center">
        {/* Left Panel - Logo */}
        <div className="w-full md:w-1/2 h-96 md:h-full bg-meraki-cream bg-opacity-50 flex items-center justify-center min-h-screen md:min-h-auto">
          <svg
        ...
        <div className="w-full md:w-1/2 bg-meraki-cream bg-opacity-[0.09] flex items-center justify-center p-8 md:p-16 min-h-screen md:min-h-auto">
          <div className="w-full max-w-md">
            <form onSubmit={handleContinue} className="space-y-8">
              {/* Title */}
              <h1 className="text-meraki-principal font-light text-xl" style={{ fontFamily: "'PP Neue Montreal', sans-serif" }}>
                Sign up
              </h1>
              ...
              <div className="flex justify-center pt-8">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="meraki-button-primary w-54 disabled:opacity-60"
                >
              ...
              <div className="text-center pt-8">
                <p className="text-meraki-body text-base font-normal">
              ...
              <div className="flex justify-center pt-4">
                <button
                  ...
                  className="meraki-button-primary w-54 flex items-center justify-center gap-3"
                >
                  <img
