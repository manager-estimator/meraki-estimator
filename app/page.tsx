...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center p-4 lg:p-16">
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row items-stretch justify-center gap-0">
        {/* Left Panel - Logo */}
        <div className="w-full lg:w-[624px] min-h-[400px] lg:h-[772px] flex items-center justify-center relative logo-panel">
        ...
        <div className="w-full lg:w-[624px] min-h-[400px] lg:h-[772px] form-panel flex items-center justify-center p-8 lg:p-16">
          <div className="w-full max-w-[406px]">
            <form onSubmit={handleContinue} className="flex flex-col">
              {/* Title */}
              <h1 className="signup-title mb-24">Sign up</h1>
              ...
              {/* Divider Text */}
              <p className="text-center text-meraki-body mb-10 body-text">
              ...
              <div className="flex justify-center mb-14">
                <button
                  ...
                  className="auth-button flex items-center justify-center gap-3"
                >
                  <img
              ...
              {/* Privacy Policy Text */}
              <p className="text-center text-meraki-body body-text">
